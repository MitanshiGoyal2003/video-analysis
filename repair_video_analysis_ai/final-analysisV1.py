...
# ============================================================================
# AUDIO TRANSCRIPTION CODE - COMMENTED OUT FOR NOW
# ============================================================================
# import subprocess
# import ast
#
...
class RepairAdvisor:
    ...
    def _build_prompt(self, 
                     vision_summary: str, 
                     # audio_keywords: Optional[List[str]] = None,  # COMMENTED OUT
    ...
    def get_recommendations(self,
        ...
        prompt = self._build_prompt(vision_summary, engineer_description)  # Removed audio_keywords
        ...
        try:
            ...
            return {
                ...
                # 'audio_keywords': audio_keywords,  # COMMENTED OUT
...
def process_vision_json(json_file_path: str, 
                       api_key: str,
                       # audio_s3_url: Optional[str] = None,  # COMMENTED OUT
                       # ssh_host: str = "ubuntu@iop.qa.onsitego.com",  # COMMENTED OUT
                       # container: str = "tst7-llm-1",  # COMMENTED OUT
                       engineer_description: Optional[str] = None) -> Dict:
    """
    ...
    print("\n[STEP 2] Initializing Repair Advisor...")
    try:
    ...
    # AUDIO TRANSCRIPT PREVIEW - COMMENTED OUT
    # if audio_transcript:
    ...
    return {
        'video_id': video_id,
        'status': 'success',
        # 'audio_transcript': audio_transcript,  # COMMENTED OUT
        # 'audio_keywords': audio_keywords,  # COMMENTED OUT
        'recommendations': recommendations,
...
if __name__ == "__main__":
    ...
    # AUDIO OPTIONS - COMMENTED OUT
    # Option 1: With audio S3 URL
    # result = process_vision_json(
    #     json_file_path=JSON_FILE,
    #     api_key=API_KEY,
    ...
    if result['status'] == 'success':
        ...
        # print(f"\nKeywords: {result.get('audio_keywords', [])}")  # COMMENTED OUT
    else:
